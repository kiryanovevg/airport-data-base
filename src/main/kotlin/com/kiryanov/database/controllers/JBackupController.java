...
public class JBackupController {
    ...
    public File executeCommand(String host, String user,
                               String databaseName, String databasePassword,
                               String type) throws RestException {
...
//        String backupFileName = "backup_" + databaseName + "_" + sdf.format(new Date()) + ".sql";
        String backupFileName = "backup_" + databaseName + "_" + "1" + ".sql";

        List<String> commands = getPgCommands(host, user, databaseName, backupFilePath, backupFileName, type);
        if (!commands.isEmpty()) {
            try {
            ...
            throw new RestException("Error: Invalid params.");
        }
    }

    private List<String> getPgCommands(String host, String user,
                                       String databaseName, File backupFilePath,
                                       String backupFileName, String type) {
